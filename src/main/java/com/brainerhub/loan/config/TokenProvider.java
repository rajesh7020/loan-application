...
public class TokenProvider implements Serializable {
    ...
    public String generateToken(Authentication authentication) throws IOException, ServletException {
        final User user = (User) authentication.getPrincipal();
        final String username = user.getUsername();
        final com.brainerhub.loan.entity.User users = userRepository.findUserByEmail(username);
